...
export const JeuxPage = lazy(() => import('src/pages/jeux'));
export const CreateJeux = lazy(() => import('src/pages/createJeux'));
export const CreatePage = lazy(() => import('src/pages/createUser'));
